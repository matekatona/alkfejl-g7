...
/*!
 * \brief SimComm::socketStateChanged is called when the state of the TCP socket SimComm::socket changes.
 *
 * It also emits the SimComm::stateChanged signal when this happens.
 * \param socketState the new socket state.
 */
void
